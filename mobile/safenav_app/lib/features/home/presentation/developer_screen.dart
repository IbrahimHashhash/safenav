...
import '../../mapbox_navigation/domain/entities/navigation_snapshot.dart';
  ...
  Widget _mapAndCoords() {
    return BlocBuilder<NavigationMapCubit, NavigationSnapshot>(
      builder: (context, snap) {
        final coords = snap.hasUserLocation
            ? 'Lat ${snap.userLat!.toStringAsFixed(6)}, '
                'Lng ${snap.userLng!.toStringAsFixed(6)}'
                '${snap.heading != null ? '  •  ${snap.heading!.toStringAsFixed(0)}°' : ''}'
            : 'Waiting for GPS…';
        return Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
